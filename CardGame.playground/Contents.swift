...
extension Deck {
    func drawCard() -> Card {
        return self.deck[Int.random(in: 0...self.deck.count - 1)]
    }
}
...
class HighLow: CardGame {
    ...
    func play() {
        ...
        if player1Card > player2Card {
            ...
            print("It is a tie, both players have the \(player1Card.description)")
        }
...
class CardGameTracker: CardGameDelegate {
    ...
    func game(player1DidDraw card1: Card, player2DidDraw card2: Card) {
        print("player 1 drew \(card1.description) and player 2 drew \(card2.description)")
    }
}
